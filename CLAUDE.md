...
> Paper Agent Pipeline: 基于 Claude Code 的学术论文自动写作系统，支持课堂作业/专科/本科/硕士多层次论文
...
> ⚠️ 课堂作业特点：简短精炼，不需要封面/摘要/目录/致谢，直接正文，重点是观点清晰、论据充分
...
**⚠️ 课堂作业关键原则：**
1. **不需要封面/摘要/目录/致谢**：直接从标题开始
2. **结构紧凑**：引言→正文→讨论→参考文献，四段式
3. **观点鲜明**：每个小节有明确的论点
4. **引用规范**：正文使用上标序号 [N]，文末按编号列出参考文献
5. **字数控制**：总字数2000-3000字，不含参考文献
